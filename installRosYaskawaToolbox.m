function installRosYaskawaToolbox(replaceExisting)
% INSTALLROSYASKAWATOOLBOX installs RosYaskawaToolbox for MATLAB.
%   INSTALLROSYASKAWATOOLBOX installs RosYaskawaToolbox into the following 
%   locations:
%                             Source: Destination
%           RosURToolboxFunctions: matlabroot\toolbox\rosyaskawa
%
%   INSTALLROSYASKAWATOOLBOX(true) installs RosYaskawaToolbox regardless of
%   whether a copy of the RosYaskawaToolbox exists in the MATLAB root.
%
%   INSTALLROSYASKAWATOOLBOX(false) installs RosYaskawaToolbox only if no copy 
%   of the RosYaskawaToolbox exists in the MATLAB root.
%
